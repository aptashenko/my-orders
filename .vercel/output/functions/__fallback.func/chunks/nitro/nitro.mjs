...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "e54b2cd3-b5b1-4368-9303-2431adccfc34",
...
const readFileState = async () => {
  ...
  try {
    const raw = await readFile$1(dataFile, "utf8");
...
const writeFileState = async (state) => {
  await mkdir(dataDir, { recursive: true });
  await writeFile$1(dataFile, `${JSON.stringify(state, null, 2)}
`, "utf8");
  return state;
};
...
const _lazy_XlQEPA = () => import('../routes/api/rates.get.mjs');
const _lazy_p1xSsG = () => import('../routes/api/state.get.mjs');
const _lazy_XM2yZX = () => import('../routes/api/state.put.mjs');
const _lazy_DI9Y8K = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });
...
export { $fetch as $, isEqual as A, stringifyParsedURL as B, stringifyQuery as C, parseQuery as D, defu as E, withTrailingSlash as F, withoutTrailingSlash as G, listener as H, readBody as a, buildAssetsURL as b, createError$1 as c, defineEventHandler as d, encodePath as e, defineRenderHandler as f, getQuery as g, getRouteRules as h, getResponseStatusText as i, getResponseStatus as j, useNitroApp as k, parseURL as l, decodePath as m, hasProtocol as n, isScriptProtocol as o, publicAssetsURL as p, joinURL as q, readState as r, withQuery as s, sanitizeStatusCode as t, useRuntimeConfig as u, getContext as v, writeState as w, baseURL as x, createHooks as y, hash$1 as z };
